     ...
     bg-white shadow-md p-5 md:px-10'>
        ...
        <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>   
         ...
         />
            ...
            <MagnifyingGlassIcon  className=' hidden md:inline-flex h-8 p-2
             cursor-pointer rounded-full text-white bg-rose-400 md:mx-2'/>
        </div>
            ...
            <div className="flex flex-col col-span-3 mx-auto">
              ...
              <div className="flex items-center border-b mb-4">
                ...
                <div className='flex'>
                  ...
                  <button onClick={search} className='flex-grow text-rose-400'>Search</button>
                </div>
            </div>
            )}
    </header>
